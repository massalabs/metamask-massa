...
export const ImportAccountModal = ({isOpen, onClose}: {isOpen: boolean, onClose: () => void}) => {
        ...
        <ModalContent>
          ...
          <ModalBody pb={6}>
            <FormControl>
              ...
              <Input ref={initialRef} placeholder='Enter Public Key' value={publicKey ?? ''} onChange={
                (evt) => {
            ...
            <FormControl mt={4}>
              ...
              <Input type={getSecretType()} placeholder='Enter Secret Key' value={secretKey ?? ''} onChange={
                (evt) => {
